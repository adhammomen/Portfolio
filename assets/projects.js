...
window.PORTFOLIO = {
  ...
  host: {
    ...
    docking: "hold on, let me put you next to me.",
    cantMove: "your browser won't let me move it. drag it next to this one?",
    seam: "there. one page.",
    xrayHint: "now drag that window over this one. go on.",
    xray: "that's the inside of it.",
    xrayOff: "and back.",
    lens: "a loupe. make it bigger and it's an x-ray.",
    carrying: "I'll bring it over.",
    ...
    replies: [
      ...
      [["come here", "closer", "bring it", "move the window", "next to", "dock"], "ok, hold on.", "dock"],
      [["x-ray", "xray", "inside", "under the hood", "how does this work", "how is this built"], "drag the other window over this one.", "xrayhint"],
      [["second window", "two windows", "another window", "other window"], "top right — or open this page in another window yourself.", null],
